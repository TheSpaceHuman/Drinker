...
$('.ajax-add-to-basket').click(function (e) {
  ...
  $.ajax({
    url: "basket/addProduct/".concat(productId, "-").concat(productQuantity)
  }).done(function () {
    console.log('Added item');
    $(this).addClass('added_to_cart');
    $.growl.notice({
      title: "",
      message: "Товар успешно добален"
    });
...
module.exports = __webpack_require__(/*! C:\Code\GitLab\drinker\resources\js\common.js */"./resources/js/common.js");
